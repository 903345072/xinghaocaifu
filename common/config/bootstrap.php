...
const WEB_STOCKET_URL = "http://dt.cnshuhai.com/stock.php?u=hongyiqihuo&type=kline";
const WEB_STOCKET_URL2 = "http://dt.cnshuhai.com/stock.php?u=hongyiqihuo&type=stock&symbol=";
const GAOPIN_URL = "http://dt.cnshuhai.com/stock.php?u=hongyiqihuo&type=kline";
/**
 * 路径别名定义
 */
